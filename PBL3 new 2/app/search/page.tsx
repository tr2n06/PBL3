...
function mapApiFlightToFlight(item: FlightApiItem): Flight {
  return {
    ...
    departure: {
      ...
      date: item.departureDate || departDate || "",
    },
    arrival: {
      ...
      date: item.arrivalDate || departDate || "",
    },
    price: {
 ...
 const basePrices = selectedFlight
  ? passengerClasses.map((c) => {
      if (c === "economy") return selectedFlight.price.economy;
      if (c === "business") return selectedFlight.price.business;
      return selectedFlight.price.firstClass;
    })
                    ...
                    <TabsContent value={tripType} className="mt-0">
                      <div className="grid grid-cols-12 items-start gap-4">
                        ...
                        <div className="col-span-12 flex items-end pt-2">
                          <Button type="button" onClick={handleSearch}className="h-12 w-full gap-2 rounded-xl text-base font-semibold bg-[#1a3557] hover:bg-[#0f1f33]">
