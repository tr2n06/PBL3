...
import {
  ...
  Ticket, CreditCard, Printer, FileText, Luggage,
} from "lucide-react";
...
export default function EmployeeBookingPage() {
  ...
  const toggleSeat = (seatId: string, type: SeatType) => {
    ...
    setActivePassengerIndex(null); // return to list automatically
  };
  ...
  if (view === "invoice" && booked) {
    ...
    return (
      <div className="max-w-3xl mx-auto space-y-5 animate-in fade-in duration-300">
        {/* Success banner – blue theme to match site */}
        <div className="flex items-center gap-4 bg-[#0b5c66]/10 border border-[#0b5c66]/30 rounded-2xl p-5">
          ...
          <div>
            ...
            <p className="text-sm text-[#0b5c66]/80 mt-0.5">
              Booking reference: <strong className="font-mono text-[#0b5c66] text-base">{booked.bookingRef}</strong>
            </p>
            <p className="text-xs text-[#0b5c66]/60 mt-0.5">Booked at: {booked.bookedAtTime}</p>
          </div>
        </div>
          ...
          <CardContent className="p-0">
            ...
            <div className="p-6 grid grid-cols-3 items-center gap-4 border-b">
              <div className="text-center">
                <p className="text-4xl font-light text-[#0b5c66]">{fl.departure.time}</p>
              ...
              <div className="text-center">
                <p className="text-4xl font-light text-[#0b5c66]">{fl.arrival.time}</p>
            ...
            <div className="p-6 border-b">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between font-bold text-gray-900 text-base border-t pt-2"><span>Total</span><span className="text-[#0b5c66] text-lg">{formatVND(booked.totalPrice)} VND</span></div>
            ...
            <div className="p-6 flex flex-wrap gap-3 justify-end">
              ...
              <Button className="gap-2 bg-[#0b5c66] hover:bg-[#094a52]" onClick={() => { setView("search"); setSearched(false); setBooked(null); }}><Plane className="w-4 h-4" /> Book Another</Button>
              <Button className="gap-2 bg-[#f5d020] hover:bg-yellow-500 text-gray-900 font-semibold" asChild>
                <Link href="/employee/tickets"><Ticket className="w-4 h-4" /> View Manage Tickets</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
    ...
    <div className="space-y-6">
      ...
      <section className="relative overflow-hidden rounded-[32px]">
        <div className="absolute inset-0 bg-cover bg-center"
          style={{ backgroundImage: "url('https://i.pinimg.com/1200x/19/64/82/19648244ab45bdbb3ca935e4f7f0fd27.jpg')" }} />
        ...
        <div className="space-y-4">
          ...
          {filteredFlights.length === 0 ? (
            ...
            filteredFlights.map((flight) => {
              ...
              return (
                <div key={flight.id} className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-visible flex flex-col xl:flex-row hover:shadow-md transition-shadow">
                  {/* Flight info */}
                  <div className="p-6 flex-1 flex flex-col justify-center min-w-[300px]">
                    <div className="flex items-center justify-between mb-4">
                      <div className="text-center">
                        <p className="text-3xl font-light text-[#0b5c66]">{flight.departure.time}</p>
                      ...
                      <div className="flex flex-col items-center flex-1 px-3">
                        <p className="text-xs text-[#0b5c66] font-medium mb-1">Direct flight</p>
                      ...
                      <div className="text-center">
                        <p className="text-3xl font-light text-[#0b5c66]">{flight.arrival.time}</p>
                  ...
                  <div className="flex flex-col sm:flex-row border-t xl:border-t-0 xl:border-l border-gray-200">
                    ...
                    {busSold ? <SoldOutCol label="PREMIUM ECONOMY" wide /> : (
                      <div onClick={() => openDialog(flight, "business")}
                        className="relative w-full sm:w-44 p-4 flex flex-col justify-center items-center bg-[#5a8fa3] text-white hover:bg-[#4a7f93] cursor-pointer transition-all hover:scale-[1.02] border-t sm:border-t-0 sm:border-l border-white/20">
                        {flight.seatsAvailable.business <= 6 && (
                          <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-teal-700 text-white text-[10px] px-2 py-0.5 rounded shadow whitespace-nowrap">{flight.seatsAvailable.business} seats left</span>
                        )}
                    ...
                    {firstSold ? <SoldOutCol label="BUSINESS" /> : (
                      <div onClick={() => openDialog(flight, "firstClass")}
                        className="relative w-full sm:w-40 p-4 flex flex-col justify-center items-center bg-[#dfad36] text-gray-900 hover:bg-[#c99a2c] cursor-pointer transition-all hover:scale-[1.02] border-t sm:border-t-0 sm:border-l border-white/20">
                        {flight.seatsAvailable.firstClass <= 4 && (
                          <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-amber-700 text-white text-[10px] px-2 py-0.5 rounded shadow whitespace-nowrap">{flight.seatsAvailable.firstClass} seats left</span>
                        )}
