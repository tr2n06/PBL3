...
import {
  ...
  ArrowRight, Landmark, QrCode, Banknote
} from "lucide-react";
...
export default function EmployeePaymentPage() {
  ...
  const [paymentMethod, setPaymentMethod] = useState<"card" | "qr" | "cash" | null>(null);
    ...
    return (
      <div className="max-w-3xl mx-auto py-10 px-4 space-y-6 animate-in fade-in zoom-in duration-500">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Agent Booking Confirmed!</h1>
          ...
          <CardContent className="p-0 bg-white">
            <div className="p-8 grid grid-cols-3 items-center gap-6 border-b">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-xs font-bold text-emerald-500 uppercase tracking-widest">Agent Paid</p>
              </div>
              <div className="text-center">
            ...
            <div className="p-8 bg-gray-50/50">
              <div className="flex justify-between items-center mb-4">
                <div className="bg-yellow-100 px-3 py-1.5 rounded-lg border border-yellow-200">
                  <span className="text-xs font-bold text-yellow-800">Customer earned {formatVND(booked.pointsEarned)} points!</span>
                </div>
              </div>
              <div className="flex justify-between items-end">
                ...
                <div className="flex gap-3">
                  ...
                  <Button className="h-12 px-6 gap-2 bg-[#f5d020] hover:bg-yellow-500 text-gray-900 font-bold shadow-lg shadow-yellow-200" asChild>
                    <Link href="/employee/tickets"><Ticket className="w-4 h-4" /> View All Tickets</Link>
                  </Button>
                </div>
              </div>
            </div>
  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-4">
      <div className="mb-10 text-center">
        <h1 className="text-4xl font-black text-gray-900 tracking-tight mb-2">Agent Checkout</h1>
      ...
      <div className="grid lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
              ...
              <div className="w-full aspect-[4/3] rounded-2xl overflow-hidden mb-4 relative">
                ...
                <div className={`absolute inset-0 bg-[#0b5c66]/10 flex items-center justify-center opacity-0 transition-opacity duration-300 ${paymentMethod === "card" ? "opacity-100" : ""}`}>
                  <div className="bg-white rounded-full p-2 shadow-lg">
                    <Check className="w-6 h-6 text-[#0b5c66] stroke-[3px]" />
                  </div>
                </div>
              </div>
              <h3 className="text-base font-bold text-gray-800">Card</h3>
            </button>
            ...
            >
              <div className="w-full aspect-[4/3] rounded-2xl overflow-hidden mb-4 relative">
                <img 
                  src="https://i.pinimg.com/736x/a4/c5/7d/a4c57d46403896867bca5ef39324f41a.jpg" 
                  alt="Cash Payment"
                  className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
                />
                <div className={`absolute inset-0 bg-[#0b5c66]/10 flex items-center justify-center opacity-0 transition-opacity duration-300 ${paymentMethod === "cash" ? "opacity-100" : ""}`}>
                  <div className="bg-white rounded-full p-2 shadow-lg">
                    <Check className="w-6 h-6 text-[#0b5c66] stroke-[3px]" />
                  </div>
                </div>
              </div>
              <h3 className="text-base font-bold text-gray-800">Cash Payment</h3>
            </button>
            ...
            >
              ...
              <h3 className="text-base font-bold text-gray-800">QR Payment</h3>
            </button>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <h2 className="text-xl font-bold text-gray-800">Agent Summary</h2>
          <Card className="rounded-[2.5rem] border-0 shadow-2xl overflow-hidden bg-[#f0f9ff]">
