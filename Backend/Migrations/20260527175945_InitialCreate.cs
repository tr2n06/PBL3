    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountFlights", x => new { x.codeFlight, x.arriveDate, x.arriveTime });
                    table.ForeignKey(
                        name: "FK_DiscountFlights_Flight_codeFlight_arriveDate_arriveTime",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Promotion_Flight_codeFlight_arriveDate_arriveTime",
                        columns: x => new { x.codeFlight, x.arriveDate, x.arriveTime },
                        principalTable: "Flight",
                        principalColumns: new[] { "codeFlight", "arriveDate", "arriveTime" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlightRequest_Flight_codeFlight_arriveDate_arriveTime",
                        columns: x => new { x.codeFlight, x.arriveDate, x.arriveTime },
                        principalTable: "Flight",
                        principalColumns: new[] { "codeFlight", "arriveDate", "arriveTime" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PromotionRequest_Flight_codeFlight_arriveDate_arriveTime",
                        columns: x => new { x.codeFlight, x.arriveDate, x.arriveTime },
                        principalTable: "Flight",
                        principalColumns: new[] { "codeFlight", "arriveDate", "arriveTime" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightRequest_codeFlight_arriveDate_arriveTime",
                table: "FlightRequest",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Promotion_codeFlight_arriveDate_arriveTime",
                table: "Promotion",
                columns: new[] { "codeFlight", "arriveDate", "arriveTime" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromotionRequest_codeFlight_arriveDate_arriveTime",
                table: "PromotionRequest",
                columns: new[] { "codeFlight", "arriveDate", "arriveTime" },
                unique: true,
                filter: "[codeFlight] IS NOT NULL AND [arriveDate] IS NOT NULL AND [arriveTime] IS NOT NULL");
