...
export async function getTicketDetail(ticketId: string) {
  const res = await fetch(
    `${getApiBaseUrl()}/api/tickets/${ticketId}`,
    {
      method: "GET",
      credentials: "include",
...
export async function requestTicketUpgrade(payload: {
  ...
  const res = await fetch(
    `${getApiBaseUrl()}/api/tickets/${payload.ticketId}/upgrade`,
    {
      method: "POST",
      credentials: "include",
      headers: { "Content-Type": "application/json" },
...
export async function addTicketBaggage(payload: {
  ...
  const res = await fetch(
    `${getApiBaseUrl()}/api/tickets/${payload.ticketId}/baggage`,
    {
      method: "POST",
      credentials: "include",
      headers: { "Content-Type": "application/json" },
...
export async function requestTicketCancellation(payload: {
  ...
  const res = await fetch(
    `${getApiBaseUrl()}/api/tickets/${payload.ticketId}/cancellation-request`,
    {
      method: "POST",
      credentials: "include",
      headers: { "Content-Type": "application/json" },
