...
import { resendRegisterOtp, verifyRegisterOtp, registerUser } from "@/lib/signup-api";
...
function VerifyEmailPageContent() {
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const pending = sessionStorage.getItem("pendingRegister");
      ...
      // sau khi OTP đúng → tạo user luôn
      await registerUser({
        name: user.name,
        email: user.email,
