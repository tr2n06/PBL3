...
function GuestPaymentPageContent() {
    ...
    return (
      <div className="flex flex-col min-h-screen justify-between bg-slate-50/30">
        ...
        <main className="flex-grow py-10 w-full">
          <div className="max-w-3xl mx-auto px-4 space-y-6 animate-in fade-in zoom-in duration-500">
              ...
              <div className="flex justify-between items-end">
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <Link href={`/search-booking?code=${booked.bookingRef}`}>
  ...
  if (viewMode === "qr-display") {
    ...
    return (
      <div className="flex flex-col min-h-screen justify-between bg-slate-50/30">
        <Header />
        <main className="flex-grow py-10 w-full">
          <div className="max-w-2xl mx-auto px-4 space-y-6 animate-in fade-in duration-300">
